...
if(!empty($country)) {
    $output = "<div class='cov-container' id='app-$rand'><country-widget country='$country' bgcolor='$bgcolor' cases='$cases' deaths='$deaths' recovered='$recovered' active='$active' labeltitle='$labeltitle' labelglobal='$labelglobal' labelcases='$labelcases' labeldeaths='$labeldeaths' labelrecovered='$labelrecovered' labelactive='$labelactive'></country-wdiget></div>";
}
else {
